...
Once the recursive planning phase has computed a target layout for each tensor in the contraction tree, the strategy must assign these layouts and compute the corresponding permutation operations. The assignment def is shown in Listing~\ref{fig:greedy_assign_permutation_pseudocode}.
