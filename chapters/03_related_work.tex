...
More recent work models tensor networks as hypergraphs, enabling more accurate representation of multi-index tensors. Gray and Kourtis~\cite{gray2021hyper} introduced a hypergraph-based contraction path optimizer that uses partitioning techniques to minimize both FLOPs and intermediate tensor sizes. This framework allows explicit incorporation of memory constraints and has been widely adopted in tools such as \texttt{cotengra}.
